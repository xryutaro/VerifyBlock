...
const contractABI = require("../artifacts/contracts/Verifyblock.sol/Verifyblock.json").abi;

program
    .name("verifyblock-cli")
    .description("CLI tool for Verifyblock smart contract")
    .version("1.0.0");
