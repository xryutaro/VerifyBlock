 ...
 * This file demonstrates how to integrate Verifyblock with a web frontend
 */

// For React/Vue/Angular applications
export class VerifyblockClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new VerifyblockClient(provider, contractAddress);
